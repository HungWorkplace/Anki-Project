  ...
  function E(C, N) {
    ...
    try {
      ...
      if (m !== null) var qt = !0;
        ...
        var vn = t(c);
        vn !== null && hl(h, vn.startTime - N), (qt = !1);
      }
      return qt;
    } finally {
      (m = null), (p = z), (g = !1);
...
function bc(e, n, t, r, l) {
  switch (n) {
    ...
    case "gotpointercapture":
      return (
        (u = l.pointerId), Dt.set(u, ct(Dt.get(u) || null, e, n, t, r, l)), !0
      );
  }
  return !1;
}
  ...
  nl = A({}, Gt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== dt &&
            (dt && e.type === "mousemove"
              ? ((_l = e.screenX - dt.screenX), (xl = e.screenY - dt.screenY))
              : (xl = _l = 0),
            (dt = e)),
          _l);
    },
      ...
      P &&
        (Is &&
          ...
          (Dn || P !== "onCompositionStart"
            ...
            : ((be = v),
              (bu = "value" in be ? be.value : be.textContent),
              (Dn = !0))),
        (_ = Fr(c, P)),
        0 < _.length &&
...
function uo(e) {
  for (; e === Ar; )
    (Ar = $n[--An]), ($n[An] = null), (Vr = $n[--An]), ($n[An] = null);
  for (; e === xn; )
    (xn = we[--Se]),
      (we[Se] = null),
      (Ve = we[--Se]),
...
function Ce(e) {
  ...
  if (io !== e)
    if (((e = { context: e, memoizedValue: n, next: null }), Vn === null)) {
      ...
      (Vn = e), (Hr.dependencies = { lanes: 0, firstContext: e });
    } else Vn = Vn.next = e;
  return n;
}
var Sn = null;
...
function Ca(e, n, t) {
  return Pn & 21
    ? (Oe(t, n) || ((t = Ps()), ($.lanes |= t), (Nn |= t), (e.baseState = !0)),
      n)
...
function xu(e, n, t, r, l, u) {
  Oa(e, n);
  var o = (n.flags & 128) !== 0;
  if (!r && !o) return l && mi(n, t, !1), Ke(e, n, u);
...
function ad(e, n, t) {
  ...
  switch ((uo(n), n.tag)) {
    ...
    case 4:
      return (
        et(), zu(e, n), e === null && Ut(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
  ...
  if (n !== 0) {
    ...
    if (n === 6) qe(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (qe(e, r), (r & 130023424) === r && ((n = _o + 500 - W()), 10 < n))
          ) {
            if (Mr(e, 0) !== 0) break;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zu(n, t | 1), de(n, W()), !(R & 6) && ((tt = W() + 500), mn()));
      }
      break;
    case 13:
      zn(function () {
...
ys = xo;
gs = zn;
var zd = { usingClientEntryPoint: !1, Events: [Zt, jn, ll, vs, hs, xo] },
  vt = {
...
Wl.createRoot(document.getElementById("root")).render(
  St.jsx(wc.StrictMode, { children: St.jsx(Rd, {}) })
);
